...
class FoodItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_item" do
    assert_difference("FoodItem.count") do
      post food_items_url, params: { food_item: { calories: @food_item.calories, name: @food_item.name } }
    end
  ...
  test "should update food_item" do
    patch food_item_url(@food_item), params: { food_item: { calories: @food_item.calories, name: @food_item.name } }
